...
def main():
    ...
    if args.task_mode == 'data2text':
        ...
        if QUICK_CHECK:
            ...
            decode_mode = 'beam'
            curr_dir = os.path.join('/content/text-generation/',
                                    args.gen_dir,
                                    '{}_{}_{}'.format(temp, split_file, decode_mode))
            print(curr_dir)
            gold_dir = os.path.join('/content/text-generation/',
                                    args.gen_dir,
                                    '{}_{}_{}'.format(temp, split_file,'gold'))
            print(gold_dir)
            write_e2e_corr(prompt_text_lst, prompt_text_dict, gold_dir)
            src_dir = os.path.join('content/text-generation/',
                                   args.gen_dir,
        ...
        if args.task_mode == 'webnlg':
            if args.eval_dataset == 'valid':
                test_path = "/content/PrefixTuning/data/webnlg_challenge_2017/dev.json"
            elif args.eval_dataset == 'test':
                test_path = "/content/PrefixTuning/data/webnlg_challenge_2017/test.json"
            else:
        ...
        if args.task_mode == 'classify-sentiment':
            ...
            test_path = "/content/text-classification/glue_data/AG-news/dev1.tsv"
